...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="currency",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="payment.currency"
            ),
        ),
        migrations.AddField(
            model_name="transaction",
        ...
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["user", "status"], name="payment_tra_user_id_33fe33_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                ...
                name="payment_tra_transac_7e0230_idx",
            ),
        ),
