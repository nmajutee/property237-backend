...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(choices=[('bank_account', 'Bank Account'), ('paypal', 'PayPal'), ('stripe', 'Stripe'), ('wallet', 'Digital Wallet'), ('crypto', 'Cryptocurrency')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fixed_fee', models.DecimalField(decimal_places=2, default=0.0, max_digits=8, validators=[django.core.validators.MinValueValidator(0)])),
                ('min_amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('requested', 'Requested'), ('approved', 'Approved'), ('processing', 'Processing'), ('completed', 'Completed'), ('rejected', 'Rejected')], default='requested', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('ad_payment', 'Advertisement Payment'), ('subscription', 'Subscription Payment'), ('commission', 'Commission Payment'), ('refund', 'Refund'), ('deposit', 'Security Deposit'), ('withdrawal', 'Withdrawal'), ('penalty', 'Penalty Fee'), ('bonus', 'Bonus Credit')], max_length=20)),
